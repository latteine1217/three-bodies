...
- **邊界收束**：僅對 3 顆恆星施加「彈簧回復力 + 微量向外阻尼」軟邊界，飛離者減速折返而非逃逸；行星不受邊界約束，純由恆星引力束縛，可自然被俘獲或彈出。
- **寫實渲染**：電漿恆星表面（米粒組織、黑子、邊緣昏暗）、黑體輻射星色、帶柔和輝光的星芒眩光（緩慢閃爍）、稀疏漂浮且逐點閃爍的星際塵埃（差速視差營造縱深）、程序生成且緩慢自轉的銀河天球、UnrealBloom 與 film grain / 暗角 / 色差 攝影後製。
